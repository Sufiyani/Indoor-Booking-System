...
// // Get all booked slots for a specific court
// export const getBookedSlots = TryCatch(async (req, res, next) => {
//   const { court } = req.params;

//   if (!['Cricket', 'Futsal', 'Padel'].includes(court)) {
//     return next(new ErrorHandler('Invalid court type', 400));
//   }
...
//   // Validation
//   if (!court || !year || !month || date === undefined || !slots || !name || !email || !paymentMethod) {
...
//   const existingBookings = await Booking.find({ court, year, month, date });

//   const alreadyBookedSlots = [];
//   existingBookings.forEach(booking => {
//     booking.slots.forEach(slot => {
//       if (slots.includes(slot)) {
//         alreadyBookedSlots.push(slot);
//       }
//     });
//   });
