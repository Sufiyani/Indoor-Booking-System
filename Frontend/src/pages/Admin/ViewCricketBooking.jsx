...
const ViewBooking = () => {
  ...
  useEffect(() => {
    const bookedData = JSON.parse(localStorage.getItem("cricketBookedSlots")) || {};
    const months = [
  ...
  return (
    <div id="view-booking-page" className="min-h-screen bg-black text-white p-10 mt-15">
