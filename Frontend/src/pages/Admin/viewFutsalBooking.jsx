...
const ViewFutsalBooking = () => {
  const [bookings, setBookings] = useState([]);
  const navigate = useNavigate();

  useEffect(() => {
    const bookedData = JSON.parse(localStorage.getItem("futsalBookedSlots")) || {};
    const months = [
  ...
  return (
    <div id="view-futsal-page" className="min-h-screen bg-black text-white p-10 mt-15">
...
export default ViewFutsalBooking;
