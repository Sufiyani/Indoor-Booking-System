...
const Cricket = () => {
  ...
  const handleBooking = () => {
    ...
    localStorage.setItem("cricketBookedSlots", JSON.stringify(updatedBooked));
    setSelectedSlots([]);
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col md:flex-row relative">
      {/* Sidebar */}
      <div className="md:w-1/4 w-full bg-gray-900 p-4 md:p-6 border-r md:border-r border-gray-700">
      ...
      <div className="md:w-3/4 w-full p-4 md:p-8">
        ...
        <p className="text-sm sm:text-lg text-white max-w-2xl text-center mx-auto mb-6 sm:mb-10">
          Cricket is one of the most popular sports in the world, with millions of fans across continents.
          From thrilling test matches to fast-paced T20 games, cricket showcases incredible skills in batting,
          bowling, and fielding. Explore legendary players, iconic moments, major tournaments, and highlights.
        </p>
