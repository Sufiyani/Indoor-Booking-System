...
//   useEffect(() => {
//     const savedSlots = JSON.parse(localStorage.getItem("cricketBookedSlots")) || {};
...
//         setShowPopup(true); // ✅ Same as Futsal — limit 3 slots
//         return;
//       }
...
//           Book your favorite time slots for indoor cricket. You can select up to 3 slots at a time.
//         </p>
...
//   // ✅ Fetch all booked slots from backend
//   useEffect(() => {
...
//           grouped[key] = grouped[key] ? [...grouped[key], ...b.slots] : [...b.slots];
//         });
...
//       {/* Main */}
//       <div className="md:w-3/4 w-full p-4 md:p-8">
//         <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
//           Cricket Ground Booking
//         </h1>
...
//               <h3 className="text-lg font-bold mb-2 text-center sm:text-left">
//                 Available Slots - {months[selectedMonth]} {selectedDate}, {selectedYear}
//               </h3>
//               <ul className="space-y-1 text-xs sm:text-sm">
//                 {timeSlots.map((slot, index) => (
//                   <li
...
//             <h2 className="text-lg font-bold text-orange-400 mb-4">Confirm Booking</h2>
//             <p>Book these {selectedSlots.length} slots?</p>
//             <div className="flex justify-center gap-4 mt-5">
//               <button onClick={() => setShowConfirmPopup(false)} className="px-4 py-2 bg-gray-600 rounded">Cancel</button>
//               <button onClick={handleConfirmBooking} className="px-4 py-2 bg-orange-600 rounded">Yes</button>
//             </div>
//           </div>
//         </div>
//       )}
...
//       {/* Main Content */}
//       <div className="md:w-3/4 w-full p-4 md:p-8">
//         <h1 className="text-3xl sm:text-4xl font-bold text-center mb-2 bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
//           Cricket Ground Booking
//         </h1>
...
//                   ${day ? "bg-gray-800 hover:bg-orange-600 cursor-pointer" : ""}
//                   ${selectedDate === day ? "bg-orange-600 font-bold" : ""}`}
//               >
//                 {day || ""}
//               </div>
//             ))
...
//                         ? "bg-orange-600 text-white font-bold scale-105" 
//                         : bookedForDate.includes(index)
//                         ? "bg-gray-700 cursor-not-allowed opacity-50"
//                         : "bg-gray-800 hover:bg-orange-600 hover:scale-105"
//                       }`}
//                     >
//                       {selectedSlots.includes(index) ? (
...
//               className="px-8 py-3 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 rounded-lg font-semibold transition transform hover:scale-105"
//             >
//               Book Now
//             </button>
//           </div>
...
//             <button
//               onClick={() => setShowPopup(false)}
//               className="mt-5 px-6 py-2 bg-orange-600 rounded hover:bg-orange-700 transition"
//             >
//               OK
//             </button>
//           </div>
          ...
          <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg text-center w-11/12 sm:w-[320px]">
            ...
            <div className="flex justify-center gap-4 mt-5">
              <button
                ...
                className="px-5 py-2 bg-orange-600 rounded hover:bg-orange-700 transition"
              >
                Yes
              </button>
              <button
