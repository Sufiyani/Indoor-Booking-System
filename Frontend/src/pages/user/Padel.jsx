...
//           Padel is a fast-paced, social sport that combines tennis and squash on an enclosed court.
//         </p>
...
//         data
//           .filter((b) => b.court === "Padel") // only show padel bookings
//           .forEach((b) => {
...
//       setBookedSlots(grouped);
//     } catch (error) {
//       console.error("Error saving padel booking:", error);
...
//             <div
//               key={day}
//               className="font-semibold text-orange-400 text-xs sm:text-sm"
//             >
//               {day}
//             </div>
//           ))}
...
//   // ✅ Confirm booking and save to backend
//   const handleConfirmBooking = async () => {
//     try {
//       await bookingService.create({
//         year: selectedYear,
...
//       alert("🎾 Padel booking confirmed successfully!");
//       setShowConfirmPopup(false);
//       setSelectedSlots([]);
...
//               <ul className="space-y-1 text-xs sm:text-sm">
//                 {timeSlots.map((slot, index) => (
//                   <li key={index} className="h-8 sm:h-10 px-2 py-1 rounded bg-gray-800">
//                     {slot}
//                   </li>
//                 ))}
//               </ul>
...
//                     ${bookedForDate.includes(index) ? "bg-gray-700 cursor-not-allowed" : ""}`}
//                   >
//                     {selectedSlots.includes(index) || bookedForDate.includes(index)
...
//           Select up to 3 slots for Padel booking.
//         </p>

//         {isLoading && <div className="text-center text-blue-400 mb-4">Loading bookings...</div>}
...
//           <div className="bg-gray-800 p-6 rounded-lg text-center">
//             <h2 className="text-lg font-bold text-blue-400 mb-4">Limit Reached</h2>
...
//         <div className="absolute inset-0 flex items-center justify-center bg-black/70 z-50">
//           <div className="bg-gray-800 p-6 rounded-lg text-center">
//             <h2 className="text-lg font-bold text-blue-400 mb-4">Already Booked</h2>
